(self["webpackChunkaudioplayer"] = self["webpackChunkaudioplayer"] || []).push([["node_modules_ionic_core_dist_esm_ion-app_8_entry_js"],{
...
/* harmony import */ var _helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./helpers-dd7e4b7b.js */ 5392);
/* harmony import */ var _cubic_bezier_eea9a7a9_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./cubic-bezier-eea9a7a9.js */ 66943);
/* harmony import */ var _framework_delegate_4392cd63_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./framework-delegate-4392cd63.js */ 54369);
/* harmony import */ var _index_931440b1_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./index-931440b1.js */ 95614);
  ...
  componentDidLoad() {
    {
      rIC(async () => {
        ...
        if (!_ionic_global_63a97a32_js__WEBPACK_IMPORTED_MODULE_1__.c.getBoolean('_testing')) {
          __webpack_require__.e(/*! import() */ "node_modules_ionic_core_dist_esm_tap-click-cc1ae2b2_js").then(__webpack_require__.bind(__webpack_require__, /*! ./tap-click-cc1ae2b2.js */ 96959)).then(module => module.startTapClick(_ionic_global_63a97a32_js__WEBPACK_IMPORTED_MODULE_1__.c));
        }
        if (_ionic_global_63a97a32_js__WEBPACK_IMPORTED_MODULE_1__.c.getBoolean('statusTap', isHybrid)) {
          __webpack_require__.e(/*! import() */ "node_modules_ionic_core_dist_esm_status-tap-bdecfebf_js").then(__webpack_require__.bind(__webpack_require__, /*! ./status-tap-bdecfebf.js */ 23465)).then(module => module.startStatusTap());
        }
        if (_ionic_global_63a97a32_js__WEBPACK_IMPORTED_MODULE_1__.c.getBoolean('inputShims', needInputShims())) {
          __webpack_require__.e(/*! import() */ "node_modules_ionic_core_dist_esm_input-shims-73f15161_js").then(__webpack_require__.bind(__webpack_require__, /*! ./input-shims-73f15161.js */ 4908)).then(module => module.startInputShims(_ionic_global_63a97a32_js__WEBPACK_IMPORTED_MODULE_1__.c));
        }
        const hardwareBackButtonModule = await Promise.resolve(/*! import() */).then(__webpack_require__.bind(__webpack_require__, /*! ./hardware-back-button-4a6b37fb.js */ 28876));
        ...
        if (typeof window !== 'undefined') {
          __webpack_require__.e(/*! import() */ "node_modules_ionic_core_dist_esm_keyboard-5742b5da_js").then(__webpack_require__.bind(__webpack_require__, /*! ./keyboard-5742b5da.js */ 18354)).then(module => module.startKeyboardAssist(window));
        }
        __webpack_require__.e(/*! import() */ "node_modules_ionic_core_dist_esm_focus-visible-f4ad4f1a_js").then(__webpack_require__.bind(__webpack_require__, /*! ./focus-visible-f4ad4f1a.js */ 16441)).then(module => module.startFocusVisible());
      });
    }
  }
  render() {
...
const Header = class {
  ...
  componentWillLoad() {
    this.inheritedAttributes = (0,_helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_3__.i)(this.el, ['role']);
  }
  ...
  render() {
    ...
    return ((0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.H, Object.assign({ role: "banner", class: {
        [mode]: true,
        // Used internally for styling
        [`header-${mode}`]: true,
...
const RouterOutlet = class {
  ...
  async connectedCallback() {
    ...
    this.gesture = (await __webpack_require__.e(/*! import() */ "node_modules_ionic_core_dist_esm_swipe-back-fae97365_js").then(__webpack_require__.bind(__webpack_require__, /*! ./swipe-back-fae97365.js */ 89773))).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), step => this.ani && this.ani.progressStep(step), (shouldComplete, step, dur) => {
      if (this.ani) {
        this.ani.onFinish(() => {
          this.gestureOrAnimationInProgress = false;
          if (this.swipeHandler) {
